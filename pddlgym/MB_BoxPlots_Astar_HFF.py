...
Group_Name = "a_Output_Astar_Hff_Uniform"
...
plt.title("A* HFF Number of Plans in Journey")
...
plt.title("A* HFF Total Actions in Journey")
...
plt.title("A* HFF Total Actions in Plans")
...
plt.title("A* HFF Total Time for Journey")
...
plt.title("A* HFF Total Planning Time")
...
plt.title("A* HFF Total Search Time")
...
plt.title("A* HFF Total Nodes Evaluated")
...
plt.title("A* HFF Total Nodes Expanded")
