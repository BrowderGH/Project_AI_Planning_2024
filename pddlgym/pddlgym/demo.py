...
def demo_random(env_name, render=True, problem_index=0, verbose=True):
    ...
    print("PDDLEnv{}-v0".format(env_name.capitalize())) #added by MB
    env.fix_problem_index(problem_index)
    policy = lambda s : env.action_space.sample(s)
    video_path = "/Users/browder_macbook/Desktop/Project/pddlgym/pddlgym/tmp/{}_random_demo.mp4".format(env_name)
    print(render)
    print("GGGGGGGGGGGG")
