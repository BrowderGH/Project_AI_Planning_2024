(define (problem doors) 
	...
	(fireat fire-1 loc-0-3)
	(fireat fire-1 loc-0-4)
	(fireat fire-1 loc-1-0)
	(fireat fire-1 loc-3-5)
	(fireat fire-1 loc-4-2)
	(fireat fire-1 loc-4-3)
	(fireat fire-1 loc-5-2)
	(fireat fire-1 loc-6-5)
