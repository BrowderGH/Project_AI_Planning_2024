(define (problem doors) 
	...
	; fire at 5-5
	(free loc-5-6)
	; we remove (free loc-5-7) because of fireball
	(free loc-6-0)
	; we remove (free loc-6-5) because of fireball
	(free loc-6-6)
	(free loc-6-7)
	(free loc-7-0)
	(free loc-7-1)
	...
	(keyat key-1 loc-3-2)
	(pick key-1)
    (keyforroom key-2 room-1)
	(keyat key-2 loc-5-3)
	(pick key-2)
	(personat person-1 loc-6-6)

	(fireat fire-1 loc-5-7)
	(fireat fire-2 loc-6-5)
	(fireat fire-2 loc-5-5)

    (wallat wall-1 loc-1-3)
	(wallat wall-2 loc-1-4)
	(wallat wall-1 loc-1-5)
	(wallat wall-2 loc-1-6)
	(wallat wall-1 loc-2-6)
	(wallat wall-2 loc-3-6)
	(wallat wall-1 loc-4-6)
	(wallat wall-2 loc-3-1)
	(wallat wall-2 loc-4-1)
	(wallat wall-1 loc-5-1)
	(wallat wall-2 loc-6-1)
	(wallat wall-1 loc-6-2)
	(wallat wall-2 loc-6-3)
