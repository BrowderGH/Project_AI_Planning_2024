(define (problem doors) 
	...
	(fireat fire-1 loc-1-1)
	(fireat fire-2 loc-3-0)
	(fireat fire-3 loc-3-2)
	(fireat fire-4 loc-3-4)
	(fireat fire-5 loc-5-4)
	(fireat fire-6 loc-4-5)
	(fireat fire-7 loc-7-0)
	(fireat fire-8 loc-7-5)
