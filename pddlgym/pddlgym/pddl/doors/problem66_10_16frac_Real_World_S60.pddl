(define (problem doors) 
	...
	(fireat fire-1 loc-0-1)
	(fireat fire-2 loc-0-3)
	(fireat fire-3 loc-0-4)
	(fireat fire-4 loc-0-5)
	(fireat fire-5 loc-3-0)
	(fireat fire-6 loc-3-4)
	(fireat fire-7 loc-5-3)
	(fireat fire-8 loc-6-5)
