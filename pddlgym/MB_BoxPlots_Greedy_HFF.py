...
Group_Name = "a_Output_Greedy_Hff_Uniform"

A1 = pd.read_csv("a_Output__Charts/a_Output_baseline_Greedy_HFF_Uniform_Main_saved.csv")
A2 = pd.read_csv("a_Output__Charts/a_Output_4PercentF_Greedy_Hff_Uniform_Main_saved.csv")
A3 = pd.read_csv("a_Output__Charts/a_Output_8PercentF_Greedy_Hff_Uniform_Main_saved.csv")
A4 = pd.read_csv("a_Output__Charts/a_Output_16PercentF_Greedy_Hff_Uniform_Main_saved.csv")
...
plt.title("GBFS HFF Number of Plans in Journey")
...
plt.title("GBFS HFF Total Actions in Journey")
...
plt.title("GBFS HFF Total Actions in Plans")
...
plt.title("GBFS HFF Total Time for Journey")
...
plt.title("GBFS HFF Total Planning Time")
...
plt.title("GBFS HFF Total Search Time")
...
plt.title("GBFS HFF Total Nodes Evaluated")
...
plt.title("GBFS HFF Total Nodes Expanded")
